...
@Entity
@Table(name = "BadgeUrls__1")
@JsonIgnoreProperties(ignoreUnknown = true)
public class BadgeUrls__1 {
    ...
    public String toString() {
        ...
        sb.append(BadgeUrls__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("small");
        sb.append('=');
