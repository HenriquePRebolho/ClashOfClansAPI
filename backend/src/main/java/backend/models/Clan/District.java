...
public class District {
    ...
    @JsonProperty("districtHallLevel")
    public Integer getDistrictHallLevel() {
        return districtHallLevel;
    }

    @JsonProperty("districtHallLevel")
    public void setDistrictHallLevel(Integer districtHallLevel) {
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("districtHallLevel");
        sb.append('=');
        sb.append(((this.districtHallLevel == null)?"<null>":this.districtHallLevel));
        sb.append(',');
